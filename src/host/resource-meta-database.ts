...
export const PLUGIN_META_DATABASE: Record<string, ResourceMeta> = {
  ...
  'dsh-free-search': {
    ...
    homepage: 'https://github.com/liustack/dsh-free-search',
    category: '搜索联网',
    icon: '🆓',
  ...
  'dsh-builtin-browser': {
    ...
    homepage: 'https://github.com/liustack/dsh-builtin-browser',
    category: '搜索联网',
    icon: '🌐',
  ...
  'dsh-agent-browser': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-agent-browser',
    category: '搜索联网',
    icon: '🕸️',
  ...
  'dsh-dream-skin': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-dream-skin',
    category: 'UI界面增强',
    icon: '🌙',
  ...
  'dsh-plugin-wallpaper-engine': {
    ...
    homepage: 'https://github.com/meyaomiao/dsh-plugin-wallpaper-engine',
    category: 'UI界面增强',
    icon: '🖼️',
  ...
  'dsh-pet': {
    ...
    homepage: 'https://github.com/kendu76/dsh-pet',
    category: 'UI界面增强',
    icon: '🐱',
    tags: ['宠物', '桌面陪伴', '动画', '治愈'],
  },
  'dsh-dafeiyu': {
    ...
    homepage: 'https://github.com/meyaomiao/dsh-dafeiyu',
    category: 'UI界面增强',
    icon: '🐟',
    tags: ['宠物', '大肥鱼', '陪伴', '桌面悬浮'],
  },
  'whale-on-desk': {
    ...
    homepage: 'https://github.com/meyaomiao/whale-on-desk',
    category: 'UI界面增强',
    icon: '🐳',
  ...
  'dsh-whale-widget': {
    ...
    homepage: 'https://github.com/meyaomiao/dsh-whale-widget',
    category: 'UI界面增强',
    icon: '🐋',
  ...
  '@aiwayds/dsh-tui-pi': {
    ...
    homepage: 'https://github.com/aiwayds/dsh-tui-pi',
    category: 'UI界面增强',
    icon: '⌨️',
  ...
  'dsh-vscode-mode': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-vscode-mode',
    category: 'UI界面增强',
    icon: '💻',
  ...
  '@kobenfang/dsh-eyes': {
    ...
    homepage: 'https://github.com/kobenfang/dsh-eyes',
    category: '视觉多模态',
    icon: '👀',
  ...
  'dsh-image-gen': {
    ...
    homepage: 'https://github.com/liustack/dsh-image-gen',
    category: '视觉多模态',
    icon: '🎨',
  ...
  '@flowingspring/dsh-voco': {
    ...
    homepage: 'https://github.com/flowingspring/dsh-voco',
    category: '视觉多模态',
    icon: '🎤',
  ...
  'dsh-agent-voice': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-agent-voice',
    category: '视觉多模态',
    icon: '🔊',
    tags: ['语音', 'TTS', '朗读', '语音合成'],
  },
  ...
  'dsh-pocket': {
    ...
    homepage: 'https://github.com/meyaomiao/dsh-pocket',
    category: '移动远程',
    icon: '👖',
  ...
  'dsh-mobile': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-mobile',
    category: '移动远程',
    icon: '📲',
  ...
  'dsh-remote': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-remote',
    category: '移动远程',
    icon: '🔗',
  ...
  'ds-harness-remote': {
    ...
    homepage: 'https://www.npmjs.com/package/ds-harness-remote',
    category: '移动远程',
    icon: '🔒',
  ...
  'dsh-remote-plugin': {
    ...
    homepage: 'https://github.com/deepseek-ai/dsh-remote-plugin',
    category: '移动远程',
    icon: '📡',
  ...
  'pi2dsh': {
    ...
    homepage: 'https://github.com/omdsh-dev/pi2dsh',
    category: '移动远程',
    icon: '🥧',
    tags: ['Pi', '桥接', '生态', '技能适配'],
  },
  ...
  'dsh-univer-office': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-univer-office',
    category: '办公效率',
    icon: '📊',
  ...
  'dsh-feishu-bot': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-feishu-bot',
    category: '办公效率',
    icon: '🐦',
  ...
  'dsh-lark-bot': {
    ...
    name: 'Lark Bot 接入',
    description: '把 DSH 装进飞书/Lark 的 bot，扫码即用，DSH Web 可视化设置，流式卡片，项目工作区，并行任务，多角色，企业级 AI 助手。',
    homepage: 'https://github.com/omdsh-dev/dsh-lark-bot',
    category: '办公效率',
    icon: '🕊️',
  ...
  'dsh-office-tools': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-office-tools',
    category: '办公效率',
    icon: '📝',
  ...
  'dsh-excel-chat': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-excel-chat',
    category: '办公效率',
    icon: '📈',
  ...
  'dsh-office': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-office',
    category: '办公效率',
    icon: '🏢',
  ...
  'dsh-wecom': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-wecom',
    category: '办公效率',
    icon: '🏭',
  ...
  'dsh-wechat': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-wechat',
    category: '办公效率',
    icon: '💚',
  ...
  '@huanlin/dsh-plugin-better-sidebar-plugin-office': {
    ...
    homepage: 'https://github.com/huanlin/dsh-plugin-better-sidebar-plugin-office',
    category: '办公效率',
    icon: '📄',
  ...
  'dsh-fund-research': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-fund-research',
    category: '金融数据',
    icon: '📊',
  ...
  'dsh-xueqiu': {
    ...
    homepage: 'https://github.com/meyaomiao/dsh-xueqiu',
    category: '金融数据',
    icon: '📈',
  ...
  'dsh-cost-meter': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-cost-meter',
    category: '金融数据',
    icon: '💰',
  ...
  'dsh-quant': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-quant',
    category: '金融数据',
    icon: '🐳',
  ...
  'clawock-dsh': {
    ...
    homepage: 'https://www.npmjs.com/package/clawock-dsh',
    category: '金融数据',
    icon: '📉',
  ...
  'dsh-win32': {
    ...
    homepage: 'https://github.com/deepseek-ai/dsh-win32',
    category: '系统运维',
    icon: '🪟',
  ...
  'dsh-plugin-ops': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-plugin-ops',
    category: '系统运维',
    icon: '🔧',
  ...
  'dsh-memory-eternal': {
    ...
    homepage: 'https://github.com/siweina/dsh-memory-eternal',
    category: '数据记忆',
    icon: '💾',
  ...
  'dsh-session-manager': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-session-manager',
    category: '数据记忆',
    icon: '📂',
  ...
  '@morlay/session-rdb': {
    ...
    homepage: 'https://github.com/morlay/session-rdb',
    category: '数据记忆',
    icon: '🗄️',
  ...
  '@morlay/session-branch': {
    ...
    homepage: 'https://github.com/morlay/session-branch',
    category: '数据记忆',
    icon: '🌿',
  ...
  '@morlay/ui-conversation-message-actions': {
    ...
    homepage: 'https://github.com/morlay/ui-conversation-message-actions',
    category: '数据记忆',
    icon: '🔄',
  ...
  'meow-memory': {
    ...
    homepage: 'https://www.npmjs.com/package/meow-memory',
    category: '数据记忆',
    icon: '🐱',
  ...
  'dsh-plugin-model-proxy': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-plugin-model-proxy',
    category: '模型路由',
    icon: '🌐',
  ...
  'dsh-llm-fallbacks': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-llm-fallbacks',
    category: '模型路由',
    icon: '🛡️',
  ...
  'dsh-agy-link': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-agy-link',
    category: '模型路由',
    icon: '🚀',
  ...
  'dsh-coding-subscription-oauth': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-coding-subscription-oauth',
    category: '模型路由',
    icon: '🔐',
  ...
  'dsh-codex-subscription': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-codex-subscription',
    category: '模型路由',
    icon: '📝',
  ...
  'dsh-codex-connect': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-codex-connect',
    category: '模型路由',
    icon: '🔗',
  ...
  '@eddyskywalker/dsh-chatgpt-subscription': {
    ...
    homepage: 'https://github.com/eddyskywalker/dsh-chatgpt-subscription',
    category: '模型路由',
    icon: '💬',
  ...
  'dsh-routing-suite': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-routing-suite',
    category: '模型路由',
    icon: '🧭',
  ...
  'dsh-plugin': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-plugin',
    category: '插件生态',
    icon: '🏪',
  ...
  'dshmarket': {
    ...
    homepage: 'https://github.com/omdsh-dev/dshmarket',
    category: '插件生态',
    icon: '🛒',
  ...
  'dsh-find-plugin': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-find-plugin',
    category: '插件生态',
    icon: '🔎',
  ...
  'dsh-plugin-catalog': {
    ...
    homepage: 'https://github.com/deepseek-ai/dsh-plugin-catalog',
    category: '插件生态',
    icon: '📑',
  ...
  'dshhub-market': {
    ...
    homepage: 'https://github.com/omdsh-dev/dshhub-market',
    category: '插件生态',
    icon: '🎟️',
  ...
  'upstream-radar': {
    ...
    homepage: 'https://github.com/omdsh-dev/upstream-radar',
    category: '插件生态',
    icon: '📡',
  ...
  'dsh-plugin-updates': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-plugin-updates',
    category: '插件生态',
    icon: '🔔',
  ...
  'dsh-webui-auth': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-webui-auth',
    category: '安全认证',
    icon: '🔐',
  ...
  'dsh-config-manager': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-config-manager',
    category: '安全认证',
    icon: '⚙️',
  ...
  'dsh-harmony': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-harmony',
    category: '安全认证',
    icon: '🎵',
  ...
  'dsh-qingagent': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-qingagent',
    category: '研究学习',
    icon: '📝',
  ...
  'lunheng-article-pipeline': {
    ...
    homepage: 'https://www.npmjs.com/package/lunheng-article-pipeline',
    category: '研究学习',
    icon: '📜',
  ...
  'gongwen-skill': {
    ...
    homepage: 'https://www.npmjs.com/package/gongwen-skill',
    category: '研究学习',
    icon: '📋',
  ...
  '@sunjuntao/dsh-prompt-library': {
    ...
    homepage: 'https://github.com/sunjuntao/dsh-prompt-library',
    category: '研究学习',
    icon: '📚',
  ...
  'dsh-vibe-math': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-vibe-math',
    category: '研究学习',
    icon: '🔢',
  ...
  '@waterwx/dsh-novel-forge': {
    ...
    homepage: 'https://github.com/waterwx/dsh-novel-forge',
    category: '研究学习',
    icon: '⚒️',
  ...
  'dsh-mcp-connector': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-mcp-connector',
    category: 'API集成',
    icon: '🔌',
  ...
  'dsh-mcp-panel': {
    ...
    homepage: 'https://github.com/deepseek-ai/dsh-mcp-panel',
    category: 'API集成',
    icon: '🎛️',
  ...
  '@microi.net/cli': {
    ...
    homepage: 'https://github.com/microi-net/cli',
    category: 'API集成',
    icon: '⚡',
  ...
  'huaweicloud-devkit': {
    ...
    homepage: 'https://www.npmjs.com/package/huaweicloud-devkit',
    category: 'API集成',
    icon: '☁️',
  ...
  '@tt-a1i/archify-dsh': {
    ...
    homepage: 'https://github.com/tt-a1i/archify-dsh',
    category: 'API集成',
    icon: '🏗️',
  ...
  'dsh-chat-import': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-chat-import',
    category: '开发工具',
    icon: '📥',
  ...
  'dsh-movein': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-movein',
    category: '开发工具',
    icon: '🏠',
  ...
  'dsh-client-auto-continue': {
    ...
    homepage: 'https://github.com/omdsh-dev/dsh-client-auto-continue',
    category: '开发工具',
    icon: '⏩',
  ...
  'dsh-plugin-ima-sync': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-plugin-ima-sync',
    category: '开发工具',
    icon: '☁️',
  ...
  'dsh-session-log-repair': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-session-log-repair',
    category: '开发工具',
    icon: '🔧',
  ...
  'deepseek-harness-zh_pro': {
    ...
    homepage: 'https://www.npmjs.com/package/deepseek-harness-zh_pro',
    category: '开发工具',
    icon: '🇨🇳',
  ...
  '@huanlin/dsh-plugin-better-locale': {
    ...
    homepage: 'https://github.com/huanlin/dsh-plugin-better-locale',
    category: '开发工具',
    icon: '🌍',
  ...
  '@lk251066/dsh-tui': {
    ...
    homepage: 'https://github.com/lk251066/dsh-tui',
    category: 'UI界面增强',
    icon: '🖥️',
    tags: ['终端', 'TUI', '多会话', '工作台'],
  },
  ...
  'beauticode-dsh': {
    ...
    homepage: 'https://www.npmjs.com/package/beauticode-dsh',
    category: 'UI界面增强',
    icon: '🖼️',
    tags: ['背景', '美化', '图片', '视频'],
  },
  'dsh-pdf-edit': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-pdf-edit',
    category: '办公效率',
    icon: '📄',
  ...
  'dsh-tauri': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-tauri',
    category: '开发工具',
    icon: '🦀',
  ...
  'dsh-plugin-subscriptions': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-plugin-subscriptions',
    category: '模型路由',
    icon: '🎫',
  ...
  'dsh-tiddlywiki': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-tiddlywiki',
    category: '数据记忆',
    icon: '📚',
  ...
  'dsh-any-background': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-any-background',
    category: 'UI界面增强',
    icon: '🎨',
    tags: ['背景', '主题色', '个性化', '色轮'],
  },
  'aqua-deepseek': {
    ...
    homepage: 'https://www.npmjs.com/package/aqua-deepseek',
    category: '金融数据',
    icon: '🐠',
  ...
  'dsh-codex-sync': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-codex-sync',
    category: '开发工具',
    icon: '🔄',
  ...
  'dsh-smooth-stream': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-smooth-stream',
    category: 'UI界面增强',
    icon: '✨',
  ...
  'dsh-ssh-tui': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-ssh-tui',
    category: '系统运维',
    icon: '🔑',
  ...
  'dsh-auth-gate': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-auth-gate',
    category: '安全认证',
    icon: '🚪',
    tags: ['认证', '应用层', '访问控制', '登录'],
  },
  'dsh-browser': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-browser',
    category: '搜索联网',
    icon: '🌐',
  ...
  'dsh-prompt-history': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-prompt-history',
    category: '开发工具',
    icon: '📜',
    tags: ['提示词', '历史', '终端风格', '导航'],
  },
  'dsh-notify-me': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-notify-me',
    category: '系统运维',
    icon: '🔔',
  ...
  'iterate-plugin': {
    ...
    homepage: 'https://www.npmjs.com/package/iterate-plugin',
    category: '开发工具',
    icon: '🔁',
  ...
  'dsh-tauri-panel': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-tauri-panel',
    category: '开发工具',
    icon: '📋',
  ...
  'dsh-deepread': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-deepread',
    category: '研究学习',
    icon: '📖',
  ...
  'dsh-usage-stats': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-usage-stats',
    category: '金融数据',
    icon: '📊',
  ...
  'dsh-mimir': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-mimir',
    category: '研究学习',
    icon: '🔬',
  ...
  'dsh-workbench': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-workbench',
    category: 'UI界面增强',
    icon: '📁',
  ...
  'dsh-mcp-sync': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-mcp-sync',
    category: 'API集成',
    icon: '🔌',
  ...
  'dsh-plugin-capabilities': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-plugin-capabilities',
    category: 'API集成',
    icon: '🎛️',
  ...
  '@kubor/dsh-bloom-theme': {
    ...
    homepage: 'https://github.com/kubor/dsh-bloom-theme',
    category: 'UI界面增强',
    icon: '🌸',
  ...
  'dsh-settings-nav-organizer': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-settings-nav-organizer',
    category: 'UI界面增强',
    icon: '🗂️',
  ...
  'dsh-local-ai': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-local-ai',
    category: '模型路由',
    icon: '🏠',
  ...
  'dsh-vision-proxy': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-vision-proxy',
    category: '视觉多模态',
    icon: '👁️',
  ...
  'dsh-tauri-ui': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-tauri-ui',
    category: 'UI界面增强',
    icon: '🎨',
  ...
  'dsh-status-rotator': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-status-rotator',
    category: 'UI界面增强',
    icon: '😄',
    tags: ['状态栏', '梗图', '短语', '趣味'],
  },
  'dsh-tray-launcher': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-tray-launcher',
    category: '系统运维',
    icon: '📥',
  ...
  'dsh-tool-vision': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-tool-vision',
    category: '视觉多模态',
    icon: '🔧',
  ...
  'dsh-testkit': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-testkit',
    category: '开发工具',
    icon: '🧪',
  ...
  '@mstar-harness/dsh': {
    ...
    homepage: 'https://www.npmjs.com/package/@mstar-harness/dsh',
    category: '开发工具',
    icon: '⭐',
  ...
  'dsh-concurrency-guard': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-concurrency-guard',
    category: '系统运维',
    icon: '🚦',
  ...
  'dsh-checkpoint-rewind': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-checkpoint-rewind',
    category: '数据记忆',
    icon: '⏪',
  ...
  'dsh-tauri-worktree': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-tauri-worktree',
    category: '开发工具',
    icon: '🌳',
  ...
  '@eternalnight/dsh-theme': {
    ...
    homepage: 'https://github.com/eternalnight/dsh-theme',
    category: 'UI界面增强',
    icon: '🎨',
  ...
  'dsh-full-remote': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-full-remote',
    category: '移动远程',
    icon: '🔐',
  ...
  'dsh-deepseek-balance-widget': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-deepseek-balance-widget',
    category: '金融数据',
    icon: '💰',
  ...
  '@awiki/dsh-plugin': {
    ...
    homepage: 'https://www.npmjs.com/package/@awiki/dsh-plugin',
    category: 'API集成',
    icon: '📡',
    tags: ['AWiki', '身份', '消息', '集成'],
  },
  'dsh-knowledge': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-knowledge',
    category: '数据记忆',
    icon: '📚',
  ...
  '@isomoes/dsh-ikanban': {
    ...
    homepage: 'https://github.com/isomoes/dsh-ikanban',
    category: '办公效率',
    icon: '📋',
  ...
  'dsh-dingo': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-dingo',
    category: '系统运维',
    icon: '🔔',
  ...
  '@crazy_th/dsh-computer-use': {
    ...
    homepage: 'https://github.com/crazy-th/dsh-computer-use',
    category: '系统运维',
    icon: '🖥️',
  ...
  '@huiliyi37/dsh-office': {
    ...
    homepage: 'https://github.com/huiliyi37/dsh-office',
    category: '办公效率',
    icon: '📄',
  ...
  'dsh-harbor-evolution': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-harbor-evolution',
    category: '数据记忆',
    icon: '🚢',
  ...
  '@p-dsh-market/conversation-knowledge-map': {
    ...
    homepage: 'https://www.npmjs.com/package/@p-dsh-market/conversation-knowledge-map',
    category: '数据记忆',
    icon: '🗺️',
  ...
  'dsh-plugin-install': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-plugin-install',
    category: '插件生态',
    icon: '📦',
  ...
  'dsh-session-pin': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-session-pin',
    category: 'UI界面增强',
    icon: '📌',
  ...
  '@aiwayds/dsh-dcp': {
    ...
    homepage: 'https://github.com/aiwayds/dsh-dcp',
    category: '数据记忆',
    icon: '🗜️',
  ...
  '@dsh-enhanced/acp': {
    ...
    homepage: 'https://www.npmjs.com/package/@dsh-enhanced/acp',
    category: 'API集成',
    icon: '🔌',
  ...
  'dsh-plugin-lookatstudy': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-plugin-lookatstudy',
    category: '研究学习',
    icon: '🎓',
  ...
  'dsh-desktop-windows': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-desktop-windows',
    category: '系统运维',
    icon: '🪟',
  ...
  'dsh-plugin-vajraclaw': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-plugin-vajraclaw',
    category: '安全认证',
    icon: '🛡️',
  ...
  'dsh-gitbash-shell': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-gitbash-shell',
    category: '开发工具',
    icon: '🐚',
  ...
  'dsh-bloub-mood': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-bloub-mood',
    category: 'UI界面增强',
    icon: '😊',
  ...
  'relay-dsh-plugin-codex': {
    ...
    homepage: 'https://www.npmjs.com/package/relay-dsh-plugin-codex',
    category: '开发工具',
    icon: '🔌',
  ...
  'dsh-lsp-actions': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-lsp-actions',
    category: '开发工具',
    icon: '🔧',
  ...
  'dsh-image-pathify': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-image-pathify',
    category: '视觉多模态',
    icon: '🖼️',
  ...
  'dsh-codex-timeline': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-codex-timeline',
    category: '数据记忆',
    icon: '📅',
  ...
  'dsh-ai4scholar': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-ai4scholar',
    category: '研究学习',
    icon: '🎓',
  ...
  'dsh-quota-panel': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-quota-panel',
    category: '金融数据',
    icon: '📊',
    tags: ['配额', '余额', '面板', '多提供商'],
  },
  ...
  '@agi-fans/dsh-tui': {
    ...
    homepage: 'https://github.com/agi-fans/dsh-tui',
    category: '开发工具',
    icon: '🖥️',
  ...
  'dsh-crew': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-crew',
    category: '开发工具',
    icon: '👥',
  ...
  'dsh-archived-chats': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-archived-chats',
    category: '数据记忆',
    icon: '📦',
  ...
  'dsh-peak-indicator': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-peak-indicator',
    category: '金融数据',
    icon: '📈',
  ...
  'dsh-plugin-marketplace': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-plugin-marketplace',
    category: '插件生态',
    icon: '🏪',
  ...
  'dsh-plugin-wiki-tools': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-plugin-wiki-tools',
    category: '数据记忆',
    icon: '📝',
  ...
  'dsh-xray': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-xray',
    category: '开发工具',
    icon: '🔍',
  ...
  'dsh-project-orchestrator': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-project-orchestrator',
    category: '开发工具',
    icon: '🎼',
  ...
  'dsh-map-tools': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-map-tools',
    category: 'API集成',
    icon: '🗺️',
    tags: ['地图', '路由', '导航', '路线规划'],
  },
  'picturereader': {
    ...
    homepage: 'https://www.npmjs.com/package/picturereader',
    category: '视觉多模态',
    icon: '👁️',
    tags: ['图像理解', '统一', '双引擎', '视觉'],
  },
  ...
  'wallpaper-engine-dsh': {
    ...
    homepage: 'https://www.npmjs.com/package/wallpaper-engine-dsh',
    category: 'UI界面增强',
    icon: '🖼️',
  ...
  '@kiwifruit/dsh-jit-viewer': {
    ...
    homepage: 'https://github.com/kiwifruit/dsh-jit-viewer',
    category: '办公效率',
    icon: '👁️',
  ...
  'dsh-output-styles': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-output-styles',
    category: '开发工具',
    icon: '🎨',
  ...
  'dsh-advisor': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-advisor',
    category: '开发工具',
    icon: '🧐',
    tags: ['顾问', '审查', '代码审查', 'omp'],
  },
  ...
  '@moguiyu/dsh-tool-tavily-search': {
    ...
    homepage: 'https://github.com/moguiyu/dsh-tool-tavily-search',
    category: '搜索联网',
    icon: '🔍',
  ...
  'dsh-observe': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-observe',
    category: '系统运维',
    icon: '📊',
  ...
  'dsh-mpkg-wallpaper': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-mpkg-wallpaper',
    category: 'UI界面增强',
    icon: '🖼️',
  ...
  'dsh-auto-classifier': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-auto-classifier',
    category: '安全认证',
    icon: '🎯',
  ...
  'dsh-updater-npm': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-updater-npm',
    category: '系统运维',
    icon: '🔄',
  ...
  'dsh-email': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-email',
    category: '办公效率',
    icon: '📧',
  ...
  'dsh-acp-server': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-acp-server',
    category: 'API集成',
    icon: '🖥️',
  ...
  'dsh-chat-sync': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-chat-sync',
    category: '数据记忆',
    icon: '🔄',
  ...
  'dsh-voice-mode': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-voice-mode',
    category: '视觉多模态',
    icon: '🎙️',
  ...
  'dsh-tool-normalizer': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-tool-normalizer',
    category: '开发工具',
    icon: '🔧',
  ...
  'dsh-plugin-vetting': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-plugin-vetting',
    category: '安全认证',
    icon: '🔍',
  ...
  'dsh-auth': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-auth',
    category: '安全认证',
    icon: '🔐',
  ...
  'dsh-daoing-memory': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-daoing-memory',
    category: '数据记忆',
    icon: '🧠',
  ...
  'dsh-quota': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-quota',
    category: '金融数据',
    icon: '🎫',
    tags: ['配额', '会员', '挂件', '使用情况'],
  },
  'dsh-diagram': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-diagram',
    category: 'UI界面增强',
    icon: '✏️',
  ...
  'dsh-kb-rag': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-kb-rag',
    category: '研究学习',
    icon: '📖',
  ...
  '@dshline/dshline': {
    ...
    homepage: 'https://github.com/dshline/dshline',
    category: 'UI界面增强',
    icon: '💻',
  ...
  'dsh-meme': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-meme',
    category: 'UI界面增强',
    icon: '😄',
  ...
  'dsh-plugin-balance': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-plugin-balance',
    category: '金融数据',
    icon: '💰',
  ...
  'dsh-ai-team': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-ai-team',
    category: '开发工具',
    icon: '👨‍💻',
  ...
  'dsh-f': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-f',
    category: '办公效率',
    icon: '🐦',
  ...
  'dsh-plugin-usage-meter': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-plugin-usage-meter',
    category: '金融数据',
    icon: '📊',
  ...
  'dsh-research-report': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-research-report',
    category: '研究学习',
    icon: '📑',
  ...
  'dsh-retrace': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-retrace',
    category: '数据记忆',
    icon: '⏪',
  ...
  'dsh-vision-router': {
    ...
    homepage: 'https://www.npmjs.com/package/dsh-vision-router',
    category: '视觉多模态',
    icon: '👁️',
